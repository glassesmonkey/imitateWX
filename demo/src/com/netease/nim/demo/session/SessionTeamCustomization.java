...
import com.netease.nim.demo.session.activity.AVChatActivity;
...
public class SessionTeamCustomization extends SessionCustomization{
    ...
    public SessionTeamCustomization(SessionTeamCustomListener listener) {
        ...
        /**
         * 自定义一个群音视频聊天提醒 imitate weixin
         */
        SessionCustomization.OptionsButton avchatMsgButton = new SessionCustomization.OptionsButton() {
            @Override
            public void onClick(Context context, View view, String sessionId) {
        ...
        avchatMsgButton.iconId = R.drawable.nim_ic_message_actionbar_team;
        optionsButtons.add(avchatMsgButton);
